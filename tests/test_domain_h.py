"""Tests for Domain H: Fraud Risk Assessment."""
...
def test_fraud_risk_dataset_shapes():
    dataset = create_fraud_risk_dataset(n_samples=300, n_features=12, seed=42)
...
def test_fraud_risk_smoke_runner(tmp_path):
    output_dir = tmp_path / "domain_h"
